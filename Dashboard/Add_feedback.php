      ...
      <li class="nav-item active">
        ...
        <div id="collapseFeedback" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_feedback.php">Add New</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row m-2">
              <div class="col-xl-12 col-md-12">
                  <?php if($update==true || $edit==true): ?>
                      <h1 class="h3 text-gray-800 mb-3">Update Feedback</h1>
                  <?php else: ?>
                      <h1 class="h3 text-gray-800 mb-3">Add New Feedback</h1>
                  <?php endif; ?>
              </div>
            </div>
            <div class="row m-2">
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group mb-0 pm-0">
                          <label class="text-primary font-weight-bold">Select Image Client :</label>
                          <div class="input-group">
                            <input type="file" name="img_feedback" class="pl-0 py-0" accept="Image/*">
                            <div class="text-danger pt-3 mb-0"><?php echo $errors['img_feedback'] ?></div>
                            <div class="d-flex flex-column">
                              <?php if($edit==true): ?>
                                <p class="text-warning pt-3 mb-0"><?php echo $errors['edit_img_feedback'] ?></p> <br>
                                <div class="d-flex align-items-center">
                                  <p class="text-primary font-weight-bold mr-3 ">Old Image :  </p>
                                  <img src="Upload/<?php echo $img_feedback ?>" alt="<?php echo $img_feedback ?>" title="<?php echo $img_feedback ?>" style="width:100px; height: 100px;">
                                </div>
                              <?php endif; ?>
                            </div>
                          </div>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group mb-0 pm-0">
                          <label class="text-primary font-weight-bold">Name Client :</label>
                          <input type="text" name="name_client" class="form-control" value="<?php echo htmlspecialchars($name_client); ?>" placeholder="Enter Name ...">
                          <div class="text-danger pt-3"><?php echo $errors['name_client'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group mb-0 pm-0">
                          <label class="text-primary font-weight-bold">Feedback Client :</label>
                          <textarea class="form-control" name="feed_client" cols="30" rows="10" placeholder="Enter Description"><?php echo htmlspecialchars($feed_client); ?></textarea>
                          <div class="text-danger pt-3"><?php echo $errors['feed_client'] ?></div>
                        </div>                      
                      </div>
                    </div>
                  </div>
            ...
            <div class="row justify-content-around bs m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_feedback" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_feedback" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_feedback" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form>
          <br>
