      ...
      <li class="nav-item active">
        ...
        <div id="collapseFooter" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_footer.php">Add New</a>
          </div>
        </div>
      </li>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row m-2 mb-4">
              <div class="col-xl-12 col-md-12">
                  <?php if($update==true || $edit==true): ?>
                      <h1 class="h3 text-gray-800 mb-3">Update Footer</h1>
                  <?php else: ?>
                      <h1 class="h3 text-gray-800 mb-3">Add New Footer</h1>
                  <?php endif; ?>
              </div>
            </div>
            <div class="row m-2">
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group mb-0 pm-0">
                          <label class="text-primary font-weight-bold">Select Image Logo Footer :</label>
                          <div class="input-group">
                            <input type="file" name="img_footer" class="pl-0 py-0" accept="Image/*">
                            <div class="text-danger pt-3 mb-0"><?php echo $errors['img_footer'] ?></div>
                            <div class="d-flex flex-column">
                              <?php if($edit==true): ?>
                                <p class="text-warning pt-3 mb-0"><?php echo $errors['edit_img_footer'] ?></p> <br>
                                <div class="d-flex align-items-center">
                                  <p class="text-primary font-weight-bold mr-3 ">Old Image :  </p>
                                  <img src="Upload/<?php echo $img_footer ?>" alt="<?php echo $img_footer ?>" title="<?php echo $img_logo ?>" style="width:100px; height: 100px;">
                                </div>
                              <?php endif; ?>
                            </div>
                          </div>
            ...
            <div class="row justify-content-around bs m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_footer" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_footer" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_footer" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form>
          <br>
