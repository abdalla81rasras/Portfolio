      ...
      <li class="nav-item active">
        ...
        <div id="collapseHome" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_home.php">Add New</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_home" value="<?php echo $id_home; ?>">
            <div class="row m-2">
              <div class="col-xl-12 col-md-12">
                  <?php if($update==true || $edit==true): ?>
                      <h1 class="h3 text-gray-800 mb-3">Update Home</h1>
                  <?php else: ?>
                      <h1 class="h3 text-gray-800 mb-3">Add New Home</h1>
                  <?php endif; ?>
              </div>
            </div>
            <div class="row m-2">
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="name_home" class="form-control" value="<?php echo htmlspecialchars($name_home); ?>" placeholder="Enter Name ...">
                          <div class="text-danger pt-3"><?php echo $errors['name_home'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          <label class="text-primary font-weight-bold">Department :</label>
                          <input type="text" name="department" class="form-control" value="<?php echo htmlspecialchars($department); ?>" placeholder="Enter Department ...">
                          <div class="text-danger pt-3"><?php echo $errors['department'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="phone_home" class="form-control" value="<?php echo htmlspecialchars($phone_home); ?>" placeholder="Enter Phone Number ...">
                          <div class="text-danger pt-3"><?php echo $errors['phone_home'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="email" name="email_home" class="form-control" value="<?php echo htmlspecialchars($email_home); ?>" placeholder="Enter Email ...">
                          <div class="text-danger pt-3"><?php echo $errors['email_home'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          <label class="text-primary font-weight-bold">Zoom :</label>
                          <input type="text" name="zoom" class="form-control" value="<?php echo htmlspecialchars($zoom); ?>" placeholder="Enter Link ...">
                          <div class="text-danger pt-3"><?php echo $errors['zoom'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col">
                        <div class="form-group">
                          <label class="text-primary font-weight-bold">Messenger :</label>
                          <input type="text" name="messenger" class="form-control" value="<?php echo htmlspecialchars($messenger); ?>" placeholder="Enter Link ...">
                          <div class="text-danger pt-3"><?php echo $errors['messenger'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col">
                        <div class="form-group mb-0 pm-0">
                          ...
                          <div class="input-group">
                            <input type="file" name="cv_home" class="pl-0 py-0" accept=".pdf,.docx">
                            <div class="text-danger pt-3 mb-0"><?php echo $errors['cv_home'] ?></div>
                            <div class="d-flex flex-column">
                              <?php if($edit==true): ?>
                                <div class="text-warning pt-3 mb-0"><?php echo $errors['edit_cv_home'] ?></div>
                                <div class="text-primary font-weight-bold mt-3">Old File : <?php echo $cv_home ?></div>
                              <?php endif; ?>
                            </div>
                          </div>
                        </div>                      
            ...
            <div class="row justify-content-around bs m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_home" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_home" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_home" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form>
          <br>
