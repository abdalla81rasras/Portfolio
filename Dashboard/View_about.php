...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseAbout" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_about.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All About</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['description_about']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['cv_about']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_about.php?edit_about=<?php echo $row['id_about']; ?>" ><i class="fa fa-edit" title="edit"></i></a> 
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
