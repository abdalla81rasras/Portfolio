...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseContact" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_contact.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Contact</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['facebook']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['twitter']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['instagram']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['linkedin']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_contact.php?edit_contact=<?php echo $row['id_contact']; ?>" ><i class="fa fa-edit" title="edit"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
