...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseFeedback" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_feedback.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Feedback</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <img src="Upload/<?php echo $row['img_feedback']; ?>" alt="<?php echo $row['img_feedback']; ?>" title="<?php echo $row['img_feedback']; ?>" height="60px" width="60px">
                        </td>
                        <td style="padding-top: 32px;"><?php echo $row['name_client']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['feed_client']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_feedback.php?edit_feedback=<?php echo $row['id_feedback']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |   
                          <a href="Add_feedback.php?delete_feedback=<?php echo $row['id_feedback']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
