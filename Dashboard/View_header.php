...
?>
      <li class="nav-item active">
        ...
        <div id="collapseHeader" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_header.php">View All</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <!-- Container Fluid-->
        <div class="container-fluid m-2" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Header & Tab</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['name_tab']; ?></td>
                        <td>
                          <img src="Upload/<?php echo $row['img_tab']; ?>" alt="<?php echo $row['img_tab']; ?>" title="<?php echo $row['img_tab']; ?>" height="60px" width="60px">
                        </td>
                        <td>
                          <img src="Upload/<?php echo $row['img_logo']; ?>" alt="<?php echo $row['img_logo']; ?>" title="<?php echo $row['img_logo']; ?>" height="60px" width="60px">
                        </td>
                        <td style="padding-top: 32px;">
                          <a href="Add_header.php?edit_header=<?php echo $row['id_header']; ?>" ><i class="fa fa-edit" title="edit"></i></a>   
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
