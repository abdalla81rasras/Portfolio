...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseImagesUnder" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_imges_underabout.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Images Under About</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <img src="Upload/<?php echo $row['img_imgs_underabout']; ?>" alt="<?php echo $row['img_imgs_underabout']; ?>" title="<?php echo $row['img_imgs_underabout']; ?>" height="60px" width="60px">
                        </td>
                        <td style="padding-top: 32px;">
                          <a href="Add_imges_underabout.php?edit_imgs_underabout=<?php echo $row['id_imgs_underabout']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |  
                          <a href="Add_imges_underabout.php?delete_imgs_underabou=<?php echo $row['id_imgs_underabout']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
