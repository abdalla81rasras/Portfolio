...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePortfolio" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_portfolio.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Portfolio</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                      <tr>
                        <th>Type of Mneu 1</th>
                        <th>Type of Mneu 2</th>
                        <th>Image Project</th>
                        <th>Name Project</th>
                        <th>Action</th>
                      </tr>
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['state']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['state2']; ?></td>
                        <td>
                          <img src="Upload/<?php echo $row['img_portfolio']; ?>" alt="<?php echo $row['img_portfolio']; ?>" title="<?php echo $row['img_portfolio']; ?>" height="60px" width="60px">
                        </td>
                        <td style="padding-top: 32px;"><?php echo $row['name_portfolio']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_portfolio.php?edit_portfolio=<?php echo $row['id_portfolio']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |   
                          <a href="Add_portfolio.php?delete_portfolio=<?php echo $row['id_portfolio']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
