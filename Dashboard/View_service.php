...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseService" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_service.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Services</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['title_service1']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['description_service1']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['title_service2']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['description_service2']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['title_service3']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['description_service3']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['title_service4']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['description_service4']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_service.php?edit_service=<?php echo $row['id_service']; ?>" ><i class="fa fa-edit" title="edit"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
