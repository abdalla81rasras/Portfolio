...
?>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUnder" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="View_underabout.php">View All</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View All Under About</h1>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 32px;"><?php echo $row['experience']; ?></td>
                        <td style="padding-top: 32px;"><?php echo $row['P_E']; ?></td>
                        <td style="padding-top: 32px;">
                          <a href="Add_underabout.php?edit_underabout=<?php echo $row['id_underabout']; ?>" ><i class="fa fa-edit" title="edit"></i></a>
                        </td>
                      <?php endwhile; ?>
                      </tr>
                    </tbody>
